...
public class Assigner {
	...
	public String checkIfPossible(Day[][] days, List<Employee> employees) {
		...
		if (failedDays.size() == 0) {
			...
			return null;
			// return "Not enough employees available for: " +
			// combineListEnglish(failedDays) + ".";
		}
	}
	...
	public Day[][] generateSchedule(Day[][] days, List<Employee> employees) {
		...
		//// }
		//// days[week][day].assign(result[0][day][(position + week*3
		// )%result[0][day].length].getAssignment());
		//// }
		// }
		// }
		// }
		...
		//
		// if( numAvailable < 5 ) {
		// JOptionPane.showMessageDialog(null, "Only " + numAvailable + " people
		// available on " + Day.getNameofDay(day), "ERROR!", JOptionPane.ERROR_MESSAGE);
		// }
